...
DEPT_TABLE = {
    # ── 식물 ──────────────────────────────────────────────────────────────
    ('식물', '식물검역', None):              ['수출지원과(검본)'],
    ('식물', '식물검역', '식물'):            ['수출지원과(검본)'],
    ('식물', '식물검역', '종자'):            ['수출지원과(검본)'],
    ('식물', '식물검역', '목재'):            ['수출지원과(검본)'],
    ('식물', '식물검역', '식물성비료/농기계'): ['농산업수출진흥과', '수출지원과(검본)'],
    ('식물', '식물검역', '목재포장재'):       ['식물방제과'],
    ('식물', '식물검역', '병해충'):           ['수출지원과(검본)', '위험관리과(검본)'],
    ('식물', '비료', None):                  ['농산업수출진흥과'],
    # ── 동물 ──────────────────────────────────────────────────────────────
    ('동물', '동물검역', None):              ['동물검역과(검본)', '위험평가과(검본)'],
    ('동물', '동물검역', '동물'):            ['동물검역과(검본)', '위험평가과(검본)'],
    ('동물', '동물검역', '축산물'):          ['위험평가과(검본)', '축산물수출위생팀(검본)'],
    ('동물', '동물검역', '동물성비료'):      ['농산업수출진흥과', '위험평가과(검본)', '축산물수출위생팀(검본)'],
    ('동물', '동물검역', '야생동물'):        ['기후부'],
    ('동물', '동물검역', '수산물'):          ['해수부'],
    ('동물', '사료첨가제', None):            ['축산환경자원과', '축산물수출위생팀(검본)'],
    ('동물', '사료첨가제', '가축'):          ['축산환경자원과', '축산물수출위생팀(검본)'],
    ('동물', '사료첨가제', '반려동물'):      ['반려산업동물의료과', '축산환경자원과', '축산물수출위생팀(검본)'],
    ('동물', '침입외래종', None):            ['기후부'],
    ('동물', '침입외래종', '동물'):          ['기후부'],
    ('동물', '침입외래종', '식물체'):        ['산림청'],
    # ── 식품 ──────────────────────────────────────────────────────────────
    ...
    ('식품', '농약', '축산물'):              ['동물약품평가과(검본)', '축산물수출위생팀(검본)'],
    ('식품', '농약', '사료'):               ['축산환경자원과', '동물약품평가과(검본)'],
    ('식품', '농약', '천연식물보호제'):      ['안전성분석과(농관원)'],
    ('식품', '농약', '규정'):               ['농산업수출진흥과'],
    ('식품', '동물용의약품', None):          ['동물약품평가과(검본)'],
    ('식품', '동물용의약품', 'MRL'):         ['동물약품평가과(검본)'],
    ('식품', '동물용의약품', '항생제'):      ['조류인플루엔자방역과', '동물약품평가과(검본)', '축산물수출위생팀(검본)'],
    ('식품', '동물용의약품', '규정'):        ['농산업수출진흥과'],
    ('식품', 'GMO/LMO', None):             ['수출지원과(검본)', '연구개발과(농진청)', '생물안전성과(농과원)'],
    ('식품', 'GMO/LMO', '사료'):           ['축산환경자원과', '연구개발과(농진청)', '생물안전성과(농과원)'],
    ('식품', 'GMO/LMO', '식물체'):         ['수출지원과(검본)', '연구개발과(농진청)', '생물안전성과(농과원)'],
    ...
    ('식품', '축산물', None):               ['축산물수출위생팀(검본)', '식약처'],
    ('식품', '축산물', '위생·안전'):        ['축산물수출위생팀(검본)', '식약처'],
    ('식품', '축산물', '품질'):             ['식약처'],
    ('식품', '사료', None):                ['축산환경자원과'],
